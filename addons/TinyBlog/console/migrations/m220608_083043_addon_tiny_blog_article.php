...
class m220608_083043_addon_tiny_blog_article extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_blog_article}}', [
            ...
            'description' => "varchar(140) NULL DEFAULT '' COMMENT '描述'",
            'position' => "int(10) NOT NULL DEFAULT '0' COMMENT '推荐位'",
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='扩展_博客_文章'");

        /* 索引设置 */
        $this->createIndex('article_id','{{%addon_tiny_blog_article}}','id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_blog_article}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
