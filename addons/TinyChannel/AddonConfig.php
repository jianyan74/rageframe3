...
namespace addons\TinyChannel;

use common\components\BaseAddonConfig;
use addons\TinyChannel\services\Application;
use addons\TinyChannel\common\components\Bootstrap;

/**
 * Class Addon
 * @package addons\TinyChannel
 */
class AddonConfig extends BaseAddonConfig
{
    ...
    public $info = [
        'name' => 'TinyChannel',
        'title' => '渠道',
        'brief_introduction' => '管理微信公众号、微信小程序、字节小程序等渠道',
        'description' => '',
        'author' => '简言',
        'version' => '1.0.0',
    ];
