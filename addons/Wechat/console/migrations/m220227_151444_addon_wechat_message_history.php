...
class m220227_151444_addon_wechat_message_history extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%addon_wechat_message_history}}', [
            ...
            'addon_name' => "varchar(200) NOT NULL DEFAULT '' COMMENT '插件名称'",
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_wechat_message_history}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
