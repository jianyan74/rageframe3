                    ...
                    <div class="borderColorGray separateChildrenWithLine whiteBG m-b-sm">
                        <div class="normalPadding">
                            <div style="height: 160px;text-align:center;" class="backgroundCover relativePosition mainPostCover">
                                <i class="fa fa-video" style="font-size: 50px;margin:0 auto;padding-top: 30px"></i>
                                <div class="bottomBar"><?= Html::encode($model['file_name']) ?></div>
                            </div>
                        </div>
                        <div class="flex-row hAlignCenter normalPadding postToolbar">
                            <div class="flex-col"><a href="<?= Url::to(['send', 'data'=> $model['media_id'], 'mediaType' => $mediaType])?>"  title="群发" data-toggle='modal' data-target='#ajaxModal'><i class="fa fa-reply-all"></i></a></div>
