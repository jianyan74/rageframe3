...
$this->params['breadcrumbs'][] = ['label' => MenuTypeEnum::getValue($type), 'url' => ['index', 'type' => $type]];
$this->params['breadcrumbs'][] = $this->title;

?>

<?= AddonHelper::jsFile('js/sortable.min.js')?>
<?= AddonHelper::jsFile('js/vuedraggable.min.js')?>
...
<div id="vueArea" class="wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <!-- 菜单编辑模式 -->
        <div class="col-sm-3" style="width: 340px;max-width: 340px;">
                        ...
                        <draggable v-model="list" :options="{group:'mainMenu'}" class="flex-row phone-foot">
                            <div v-for="(item,index) in list" class="flex-col custommenu">
                                <div class="custommenu_sub_container">
                                    ...
                                    <div v-show="item.sub_button.length < maxSubItemCount"><a class="btn btn-block btn-white" @click="addSubItem(item.sub_button)"><i class="icon ion-plus"></i></a></div>
                                </div>
                                <a class="btn btn-block btn-white" :class="{active:crtItem === item}" @click="crtItem = item">{{item.name}}</a>
                            </div>
                            <div class="flex-col" v-show="list.length < maxItemCount"><a class="btn btn-block btn-white" @click="addItem"><i class="icon ion-plus"></i> 添加菜单</a></div>
                        </draggable>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-9">
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="col-lg-12">
                                ...
                                <?php if ($type == MenuTypeEnum::INDIVIDUATION){ ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                ...
                -->
                <div class="col-sm-7" v-if="crtItem">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">菜单设置</h3>
                            <a @click="deleteCrtItem" class="float-right" style="font-size: 14px">删除菜单</a>
                        </div>
