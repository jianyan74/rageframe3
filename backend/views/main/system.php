            ...
            <div class="box-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?= extension_loaded('gd')
                                ? '<span class="label label-primary">gd 支持</span>'
                                : '<span class="label label-default">gd 不支持</span>'; ?>
                            <?= extension_loaded('imagick')
                                ? '<span class="label label-primary">imagick 支持</span>'
                                : '<span class="label label-default">imagick 不支持</span>'; ?>
                            <?= extension_loaded('curl')
                                ? '<span class="label label-primary">curl 支持</span>'
                                : '<span class="label label-default">curl 不支持</span>'; ?>
                            <?= extension_loaded('fileinfo')
                                ? '<span class="label label-primary">fileinfo 支持</span>'
                                : '<span class="label label-default">fileinfo 不支持</span>'; ?>
                            <?= extension_loaded('intl')
                                ? '<span class="label label-primary">intl 支持</span>'
                                : '<span class="label label-default">intl 不支持</span>'; ?>
                            <?= extension_loaded('mbstring')
                                ? '<span class="label label-primary">mbstring 支持</span>'
                                : '<span class="label label-default">mbstring 不支持</span>'; ?>
                            <?= extension_loaded('intl')
                                ? '<span class="label label-primary">exif 支持</span>'
                                : '<span class="label label-default">exif 不支持</span>'; ?>
                            <?= extension_loaded('openssl')
                                ? '<span class="label label-primary">openssl 支持</span>'
                                : '<span class="label label-default">openssl 不支持</span>'; ?>
                            <?= extension_loaded('Zend OPcache')
                                ? '<span class="label label-primary">opcache 支持</span>'
                                : '<span class="label label-default">opcache 不支持</span>'; ?>
                            <?= extension_loaded('redis')
                                ? '<span class="label label-primary">redis 支持</span>'
                                : '<span class="label label-default">redis 不支持</span>'; ?>
                            <?= extension_loaded('swoole')
                                ? '<span class="label label-primary">swoole 支持</span>'
                                : '<span class="label label-default">swoole 不支持</span>'; ?>
                            <?= extension_loaded('mongodb')
                                ? '<span class="label label-primary">mongodb 支持</span>'
                                : '<span class="label label-default">mongodb 不支持</span>'; ?>
                            <?= extension_loaded('amqp')
                                ? '<span class="label label-primary">amqp 支持</span>'
                                : '<span class="label label-default">amqp 不支持</span>'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>禁用的函数</td>
