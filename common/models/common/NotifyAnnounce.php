...
/**
 * This is the model class for table "{{%common_notify_announce}}".
 *
 * @property int $id 主键
...
class NotifyAnnounce extends \common\models\base\BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['member_id', 'merchant_id', 'status', 'created_at', 'updated_at'], 'integer'],
            [['content'], 'string'],
    ...
    {
        Yii::$app->services->notify->createAnnounce($this->title, $this->status, $this->id);
