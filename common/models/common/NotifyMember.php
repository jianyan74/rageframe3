...
/**
 * This is the model class for table "{{%common_notify_member}}".
 *
 * @property int $id
 ...
 * @property int $read_member_id 已读用户
...
class NotifyMember extends \common\models\base\BaseModel
{
    ...
    {
        return [
            [['merchant_id', 'member_id', 'notify_id', 'is_read', 'read_member_id', 'type', 'status', 'created_at', 'updated_at'], 'integer'],
