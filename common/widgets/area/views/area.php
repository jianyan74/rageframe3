...
<style>
    .rf-area .table > thead > tr > th,
    .rf-area .table > tbody > tr > th,
    .rf-area .table > tfoot > tr > th,
    .rf-area .table > thead > tr > td,
    .rf-area .table > tbody > tr > td,
    .rf-area .table > tfoot > tr > td {
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close closeAjaxModalLgForExpress" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body rf-area" style="overflow: visible">
                <table class="table">
                    <tbody>
