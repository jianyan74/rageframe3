    ...
    <div class="avatar-body">
        <div class="row">
            <div class="col-md-9 m-t-sm">
                当前区域(宽度：<span class="crop-width">0</span>px; 高度：<span class="crop-height">0</span>px)，仅支持 jpeg/png 图片类型
            </div>
            ...
            <div class="col-md-3">
                <div class="avatar-upload pull-right">
                    ...
                    <input type="file" accept="image/jpeg, image/png" name="file" id="avatarInput" class="hide" onchange="selectImg(this)">
                </div>
            </div>
            <div class="col-md-9">
