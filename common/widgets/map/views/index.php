...
<div class="row" id="<?= $boxId; ?>">
    <div class="col-lg-12">
        ...
        <div class="hidden">
            <a href="<?= Url::to(['/map/input', 'boxId' => $boxId]) ?>" data-toggle="modal" data-target="#ajaxModal"
               class="rfEditMap"></a>
            <a href="<?= Url::to([
                '/map/map',
                'type' => $type,
                ...
                'boxId' => $boxId,
            ]) ?>" class="rfMap" data-toggle="modal" data-target="#ajaxModalMax"></a>
            <?= Html::hiddenInput($name.'[longitude]', $value['longitude'], ['class' => 'mapLng']); ?>
            <?= Html::hiddenInput($name.'[latitude]', $value['latitude'], ['class' => 'mapLat']); ?>
        </div>
    </div>
</div>
