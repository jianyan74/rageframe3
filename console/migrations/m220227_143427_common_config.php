...
1:开启;','remark'=>'开启此项后，连接将用SSL的形式，此项需要SMTP服务器支持','is_hide_remark'=>'0','default_value'=>'','sort'=>'3','status'=>'1','created_at'=>'1526438237','updated_at'=>'1526439059']);
        ...
        $this->insert('{{%common_config}}',['id'=>'35','title'=>'支付密钥','name'=>'wechat_mch_secret_key','app_id'=>'backend','type'=>'secretKeyText','cate_id'=>'9','extra'=>'32','remark'=>'','is_hide_remark'=>'1','default_value'=>'','sort'=>'2','status'=>'1','created_at'=>'1526711047','updated_at'=>'1591683622']);
        $this->insert('{{%common_config}}',['id'=>'36','title'=>'证书公钥','name'=>'wechat_mch_public_cert_path','app_id'=>'backend','type'=>'text','cate_id'=>'9','extra'=>'','remark'=>'如需使用敏感接口(如退款、发送红包等)需要配置 API 证书路径(登录商户平台下载 API 证书),注意路径为绝对路径','is_hide_remark'=>'0','default_value'=>'','sort'=>'3','status'=>'1','created_at'=>'1526711138','updated_at'=>'1591683623']);
        $this->insert('{{%common_config}}',['id'=>'37','title'=>'证书私钥','name'=>'wechat_mch_secret_cert','app_id'=>'backend','type'=>'text','cate_id'=>'9','extra'=>'','remark'=>'如需使用敏感接口(如退款、发送红包等)需要配置 API 证书路径(登录商户平台下载 API 证书),注意路径为绝对路径','is_hide_remark'=>'0','default_value'=>'','sort'=>'4','status'=>'1','created_at'=>'1526711237','updated_at'=>'1591683624']);
        ...
        $this->insert('{{%common_config}}',['id'=>'48','title'=>'应用 Appid','name'=>'alipay_app_id','app_id'=>'backend','type'=>'text','cate_id'=>'8','extra'=>'','remark'=>'使用创建应用时候生成的 appid','is_hide_remark'=>'0','default_value'=>'','sort'=>'0','status'=>'1','created_at'=>'1527668387','updated_at'=>'1594267768']);
        ...
        $this->insert('{{%common_config}}',['id'=>'50','title'=>'应用公钥','name'=>'alipay_app_public_cert_path','app_id'=>'backend','type'=>'text','cate_id'=>'8','extra'=>'','remark'=>'必须配置；生成地址：https://miniu.alipay.com/keytool/create','is_hide_remark'=>'0','default_value'=>'','sort'=>'2','status'=>'1','created_at'=>'1526711138','updated_at'=>'1636081104']);
...
0:关闭,','remark'=>'','is_hide_remark'=>'1','default_value'=>'0','sort'=>'6','status'=>'1','created_at'=>'1554870877','updated_at'=>'1577522181']);
        $this->insert('{{%common_config}}',['id'=>'67','title'=>'支付宝公钥','name'=>'alipay_public_cert_path','app_id'=>'backend','type'=>'text','cate_id'=>'8','extra'=>'','remark'=>'回调验证签名必须','is_hide_remark'=>'0','default_value'=>'','sort'=>'4','status'=>'1','created_at'=>'1557815671','updated_at'=>'1636081112']);
...
https:https,','remark'=>'','is_hide_remark'=>'1','default_value'=>'http','sort'=>'3','status'=>'1','created_at'=>'1577522012','updated_at'=>'1577522176']);
        $this->insert('{{%common_config}}',['id'=>'113','title'=>'RSA 公钥','name'=>'wechat_public_cert_path','app_id'=>'backend','type'=>'text','cate_id'=>'9','extra'=>'','remark'=>'企业付款需要用到双向证书，请参考：https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=4_3','is_hide_remark'=>'0','default_value'=>'','sort'=>'5','status'=>'1','created_at'=>'1579158737','updated_at'=>'1591683625']);
        ...
        $this->insert('{{%common_config}}',['id'=>'140','title'=>'Token','name'=>'byte_dance_app_token','app_id'=>'backend','type'=>'secretKeyText','cate_id'=>'61','extra'=>'32','remark'=>'令牌','is_hide_remark'=>'0','default_value'=>'','sort'=>'1','status'=>'1','created_at'=>'1619509228','updated_at'=>'1619509275']);
