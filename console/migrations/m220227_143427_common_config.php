...
class m220227_143427_common_config extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%common_config}}',['id'=>'8','title'=>'公众号帐号','name'=>'wechat_mp_account','app_id'=>'backend','type'=>'text','cate_id'=>'19','extra'=>'','remark'=>'填写公众号的帐号，一般为英文帐号','is_hide_remark'=>'0','default_value'=>'','sort'=>'0','status'=>'1','created_at'=>'1526374732','updated_at'=>'1526376340']);
