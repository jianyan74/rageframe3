...
class m220227_143427_common_menu_cate extends Migration
{
    public function up()
    {
        ...
        /* 表数据 */
        $this->insert('{{%common_menu_cate}}',['id'=>'1','title'=>'系统','name'=>'system','app_id'=>'backend','icon'=>'fa-cogs','type'=>'0','is_default_show'=>'0','is_addon'=>'0','addon_name'=>'','addon_location'=>'','sort'=>'1000','level'=>'1','tree'=>'0 ','pid'=>'0','pattern'=>'""','status'=>'1','created_at'=>'1633681071','updated_at'=>'1638170529']);
        $this->insert('{{%common_menu_cate}}',['id'=>'2','title'=>'应用','name'=>'addons','app_id'=>'backend','icon'=>'fa-th-large','type'=>'1','is_default_show'=>'0','is_addon'=>'0','addon_name'=>'','addon_location'=>'','sort'=>'1001','level'=>'1','tree'=>'0 ','pid'=>'0','pattern'=>'""','status'=>'1','created_at'=>'1633681198','updated_at'=>'1640237234']);
        $this->insert('{{%common_menu_cate}}',['id'=>'3','title'=>'应用','name'=>'menuAddons','app_id'=>'merchant','icon'=>'fa-th-large','type'=>'1','is_default_show'=>'0','is_addon'=>'0','addon_name'=>'','addon_location'=>'','sort'=>'1000','level'=>'1','tree'=>'0','pid'=>'0','pattern'=>'""','status'=>'1','created_at'=>'1638248633','updated_at'=>'1640237255']);
