...
class m220227_143427_common_notify extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%common_notify}}', [
            ...
            'link' => "varchar(255) NULL DEFAULT '' COMMENT '详情链接'",
        ...
        /* 索引设置 */
        $this->createIndex('target_type','{{%common_notify}}','target_type',0);
        $this->createIndex('merchant_id','{{%common_notify}}','merchant_id',0);
