...
class m220227_143429_rbac_auth_role extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%rbac_auth_role}}', [
            ...
            'operating_type' => "tinyint(4) NULL DEFAULT '2' COMMENT '运营类型'",
            'annual_fee' => "decimal(10,2) NULL DEFAULT '0.00' COMMENT '年费'",
