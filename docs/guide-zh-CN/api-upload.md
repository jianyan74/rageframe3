...
```
/v1/common/file/images?access-token=[access-token]
```
...
```
/v1/common/file/videos?access-token=[access-token]
```
...
```
/v1/common/file/voices?access-token=[access-token]
```
...
```
/v1/common/file/files?access-token=[access-token]
```
...
```
/v1/common/file/base64?access-token=[access-token]
```
...
```
/v1/common/file/oss-accredit?access-token=[access-token]
```
